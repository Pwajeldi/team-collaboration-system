...
import { useFetchPotentialAttendees } from "../hooks/calendarHook";
...
const EventFormModal = ({ initialStart, initialEnd, onClose, onSuccess }: EventFormModalProps) => {
    const attendeesQuery = useFetchPotentialAttendees();
    ...
    const filteredAttendees = useMemo(() => {
        const list = attendeesQuery.data ?? [];
    ...
    }, [attendeesQuery.data, attendeeSearch]);
                ...
                <form onSubmit={(e) => { e.preventDefault(); e.stopPropagation(); form.handleSubmit(); }}>
                    ...
                    <div className="event-form-group">
                        ...
                        <form.Field name="attendeeIds">
                            {(field) => {
                                const selectedUsers = (attendeesQuery.data ?? []).filter((u) =>
                                ...
                                return (
                                    <>
                                        ...
                                        <div className="attendee-list">
                                            {attendeesQuery.isLoading && <p className="attendee-empty">Loading…</p>}
                                            {!attendeesQuery.isLoading && filteredAttendees.length === 0 && (
